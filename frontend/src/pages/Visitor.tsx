...
const testimonials = [
     ...
     content: 'This platform transformed how I manage my team and personal goals. Everything is finally organized!',
     rating: 5,
   ...
   },
  {
    ...
    content: 'The habit tracking and goal management features helped me build a consistent routine. Highly recommended!',
    rating: 5,
  ...
  },
  {
    ...
    content: 'Love how I can connect my goals to daily tasks. It keeps me motivated and on track.',
    rating: 5,
...
const demoSteps = [
    ...
    mockup: (
      <div className="bg-white rounded-lg p-4 shadow-md border border-gray-200">
        <div className="flex items-center space-x-3 mb-3">
          ...
          <span className="font-semibold text-gray-900">Objectives for Goal</span>
        </div>
        <div className="space-y-3">
          <div className="flex items-center space-x-3 p-3 bg-purple-50 rounded-lg border border-purple-200">
            <input type="checkbox" checked readOnly className="w-4 h-4 text-purple-600" />
            <div className="flex-1">
              <div className="font-medium text-gray-900">Conduct Market Research</div>
              <div className="text-sm text-gray-600">Analyze competitors and target audience</div>
            </div>
            <span className="text-xs bg-purple-100 text-purple-800 px-2 py-1 rounded-full">High</span>
          </div>
          <div className="flex items-center space-x-3 p-3 bg-purple-50 rounded-lg border border-purple-200">
            <input type="checkbox" checked readOnly className="w-4 h-4 text-purple-600" />
            <div className="flex-1">
              <div className="font-medium text-gray-900">Develop Website</div>
              <div className="text-sm text-gray-600">Build e-commerce platform</div>
            </div>
            <span className="text-xs bg-purple-100 text-purple-800 px-2 py-1 rounded-full">High</span>
          </div>
          <div className="flex items-center space-x-3 p-3 bg-purple-50 rounded-lg border border-purple-200">
            <input type="checkbox" readOnly className="w-4 h-4 text-purple-600" />
            <div className="flex-1">
              <div className="font-medium text-gray-900">Create Marketing Strategy</div>
              <div className="text-sm text-gray-600">Plan digital marketing campaigns</div>
            </div>
            <span className="text-xs bg-purple-100 text-purple-800 px-2 py-1 rounded-full">Medium</span>
          </div>
        </div>
      </div>
    )
    ...
    mockup: (
      <div className="bg-white rounded-lg p-4 shadow-md border border-gray-200">
        <div className="flex items-center space-x-3 mb-3">
          ...
          <span className="font-semibold text-gray-900">Projects for "Conduct Market Research"</span>
        </div>
        <div className="space-y-3">
          ...
          <div className="p-3 bg-indigo-50 rounded-lg border border-indigo-200">
            <div className="flex items-center justify-between mb-2">
              <div className="font-medium text-gray-900">Market Trends Report</div>
              <span className="text-xs bg-gray-100 text-gray-800 px-2 py-1 rounded-full">Planned</span>
            </div>
  ...
  },
  {
    ...
    example: "Research top 10 competitors, Create survey questions, Analyze data",
    icon: <CheckSquare className="w-8 h-8 text-green-600" />,
    mockup: (
      <div className="bg-white rounded-lg p-4 shadow-md border border-gray-200">
        <div className="flex items-center space-x-3 mb-3">
          <CheckSquare className="w-5 h-5 text-green-600" />
          <span className="font-semibold text-gray-900">Tasks for "Competitor Analysis"</span>
        </div>
        <div className="space-y-2">
          <div className="flex items-center space-x-3 p-2 bg-green-50 rounded-lg">
            <input type="checkbox" checked readOnly className="w-4 h-4 text-green-600" />
            <div className="flex-1">
              <div className="font-medium text-gray-900">Research top 10 competitors</div>
              <div className="text-sm text-gray-600">Identify main competitors in the market</div>
            </div>
          ...
          <div className="flex items-center space-x-3 p-2 bg-green-50 rounded-lg">
            <input type="checkbox" checked readOnly className="w-4 h-4 text-green-600" />
            <div className="flex-1">
              <div className="font-medium text-gray-900">Analyze pricing strategies</div>
              <div className="text-sm text-gray-600">Compare pricing models and strategies</div>
            </div>
            <span className="text-xs bg-green-100 text-green-800 px-2 py-1 rounded-full">Completed</span>
          </div>
          <div className="flex items-center space-x-3 p-2 bg-green-50 rounded-lg">
            <input type="checkbox" readOnly className="w-4 h-4 text-green-600" />
            <div className="flex-1">
              <div className="font-medium text-gray-900">Create competitive analysis report</div>
              <div className="text-sm text-gray-600">Document findings and insights</div>
            </div>
          ...
          <div className="flex items-center space-x-3 p-2 bg-green-50 rounded-lg">
            <input type="checkbox" readOnly className="w-4 h-4 text-green-600" />
            <div className="flex-1">
              <div className="font-medium text-gray-900">Present findings to team</div>
              <div className="text-sm text-gray-600">Share insights with stakeholders</div>
            </div>
            <span className="text-xs bg-gray-100 text-gray-800 px-2 py-1 rounded-full">Planned</span>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center space-x-4">
              <Link to="/login" className="hidden sm:block text-gray-600 hover:text-primary-600 font-medium transition-all duration-300 hover:scale-105">
                Sign In
              </Link>
              <Link to="/register">
                <motion.button 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                The comprehensive platform for teams, project managers, and individuals to set goals, 
                manage projects, and track progress with clarity and confidence.
              </p>
                    ...
                    <div className="space-y-2">
                      <div className="bg-white rounded-lg p-3 shadow-sm">
                        <div className="flex items-center justify-between">
                          <span className="text-sm font-medium">Launch New Product</span>
                          <span className="text-xs text-green-600 bg-green-100 px-2 py-1 rounded-full">75%</span>
                        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Transform your productivity and achieve your goals with our comprehensive life management system.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Everything you need to organize your life, achieve your goals, and build lasting habits.
            </p>
          </motion.div>
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 group-hover:border-primary-200 h-full flex flex-col">
                  <div className={`p-3 bg-gradient-to-br ${feature.color} rounded-lg w-16 h-16 mb-4 flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-300 flex-shrink-0`}>
                    {feature.icon}
                  </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our intuitive hierarchy helps you organize everything from big-picture goals to daily tasks.
            </p>
          </motion.div>
                  ...
                  {step.title && (
                    <div className="text-center">
                      <h3 className="font-semibold text-gray-900 text-lg">{step.title}</h3>
                                             <p className="text-gray-600 text-sm mt-1 max-w-32">{step.desc}</p>
                    </div>
                  )}
                </motion.div>
              ))}
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Follow this step-by-step process to create your own goal hierarchy and start achieving your dreams.
            </p>
          </motion.div>
              ...
              >
                <div className="flex-1">
                  <div className="flex items-center space-x-4 mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-gray-900">{demoStep.title}</h3>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3">
                      {demoStep.icon}
                      <span className="text-lg font-semibold text-gray-900">Example:</span>
                    </div>
                    <div className="bg-gradient-to-r from-primary-50 to-indigo-50 rounded-lg p-4 border border-primary-200">
                      <p className="text-gray-800 font-medium">{demoStep.example}</p>
                    </div>
          ...
          >
            <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-2xl p-8 border border-green-200">
              ...
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                Join thousands of users who have already transformed their productivity with our intuitive goal management system.
              </p>
              <Link to="/register">
             ...
             {testimonials.map((testimonial, index) => (
               ...
               >
                 <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 h-full flex flex-col">
                   ...
                   <p className="text-gray-600 mb-4 italic flex-grow">"{testimonial.content}"</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                The comprehensive platform for life management and goal achievement.
              </p>
            </div>
                                      <div>
               ...
               <ul className="space-y-2 text-gray-400">
                 ...
                 <li><a href="#demo" className="hover:text-white transition-colors cursor-pointer">Demo</a></li>
               </ul>
             </div>
             <div>
             ...
             <div>
               ...
               <ul className="space-y-2 text-gray-400">
                 ...
                 <li><a href="#docs" className="hover:text-white transition-colors cursor-pointer">Documentation</a></li>
                 <li><a href="#status" className="hover:text-white transition-colors cursor-pointer">Status</a></li>
               </ul>
             </div>
          </div>
